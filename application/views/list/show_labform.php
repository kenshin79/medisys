...
echo "<div align=\"center\"><h3><a name=\"top\">Laboratory Flow Sheet No. 1</a></h3>";
...
//CBC table
if (!strcmp($one_gm, "y"))  
    echo form_open('show/update_cbc');
...
//Blood Chemistry
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_bloodchem');
...
//labels
    ...
    if ($row->bloodchem)
        $ebloodchem = explode(",", $row->bloodchem); 
...
//Protime/PTT
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_protime');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//Urinalysis table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_urine');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//ABG table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_abg');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//fecalysis table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_fecalysis');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
if ($row->fecalysis)
     $efecalysis = explode(",", $row->fecalysis); 
...
//uchem table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_uchem');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//culture table
if (!strcmp($one_gm, "y"))
echo form_open('show/update_culture');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//imaging table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_imaging');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
    elseif (!strcmp($my_service, 'er'))
        $vars['eadmission'] = $row->er_id;
...
//ecg table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_ecg');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
...
//others table
if (!strcmp($one_gm, "y"))
    echo form_open('show/update_others');
    if (!strcmp($my_service, 'micu'))
        $vars['eadmission'] = $row->micu_id;
